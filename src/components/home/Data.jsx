...
const Data = () => {
  return (
    <div className="home__data">
      <h3 className="home__subtitle_hello">
            Hello, I am
        </h3>
        ...
        <h3 className="home__subtitle">
            Final Year Student at VNIT, Nagpur
        </h3>

        <h3 className="home__subtitle">
            Ex-Summer Intern at UBS
        </h3>

        <div className='home__description'>
            <p>I’m a software enthusiast passionate about transforming ideas into interactive digital experiences.
            </p>
            <p>
              My interests lie in Web Development, AI-powered applications, and crafting tools that solve real-world problems.
            </p>
            <p>
              I love exploring new technologies, building projects that challenge my creativity, and continuously learning how tech can create impact at scale.
            </p>
        </div>
